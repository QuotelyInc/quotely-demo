      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="contact-info space-y-3 text-sm text-gray-300">
              <div className="contact-item">
                <strong className="text-white">Email:</strong> <a href="mailto:support@tryquotely.com" className="hover:text-white transition-colors">support@tryquotely.com</a>
              </div>
              <div className="contact-item">
                <strong className="text-white">Phone:</strong> <a href="tel:+19183956335" className="hover:text-white transition-colors">(918) 395-6335</a>
              </div>
              <div className="contact-item">
                <strong className="text-white">Address:</strong> 6010 S 66th E Ave Ste B, Tulsa, OK 74145
              </div>
              <div className="contact-item">
                <strong className="text-white">Website:</strong> <a href="https://tryquotely.com" className="hover:text-white transition-colors">https://tryquotely.com</a>
              </div>
            </div>
          </div>
