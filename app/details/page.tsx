...
export const metadata = {
  title:
    "Detailed Platform Comparison - Quotely vs competitor platforms & Applied",
  description:
    "In-depth comparison of Quotely against legacy insurance platforms. See detailed metrics, testimonials, and platform capabilities.",
};
