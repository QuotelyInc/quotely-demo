    ...
    <>
      ...
      <div className="bg-gray-900 min-h-screen">
        ...
        <section className=" bg-gray-800 -mt-32">
          <div className="items-center space-y-8 lg:space-y-12 max-w-7xl mx-auto p-4 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 grid grid-cols-2 gap-4">
            {/* Header Content */}
            <div className="text-center max-w-4xl mx-auto">
              <div className="text-9xl text-left sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Experience the{" "}
                <span className="bg-gradient-to-r from-purple-500 to-cyan-400 bg-clip-text text-transparent">
                  Speed Difference
                </span>
              </div>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-400 max-w-3xl mx-auto mt-4 sm:mt-6 leading-relaxed">
        ...
        <div id="demo-video" className="py-16 bg-gray-900">
