      ...
      <section className="comparison-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              See why Quotely outperforms EZLynx in every category that matters
            </p>
          </div>
            ...
            <table className="comparison-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="quotely-col">
                    <span className="check">✓</span> 4.2 seconds
                  </td>
                  <td>
                    <span className="cross">✗</span> 12+ seconds
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">AI Transparency</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> 100% Explainable
                  </td>
                  <td>
                    <span className="cross">✗</span> Black Box
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">Monthly Pricing</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> From $679
                  </td>
                  <td>
                    <span className="cross">✗</span> From $1,099
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">Setup Time</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> &lt; 2 minutes
                  </td>
                  <td>
                    <span className="cross">✗</span> 2-4 weeks
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">Multi-Carrier Comparison</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> 8.7 seconds
                  </td>
                  <td>
                    <span className="partial">⚠</span> 25+ seconds
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">Mobile App</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> Full Featured
                  </td>
                  <td>
                    <span className="partial">⚠</span> Limited
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">API Access</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> Open API
                  </td>
                  <td>
                    <span className="partial">⚠</span> Restricted
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">Customer Support</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> 24/7 Live Chat
                  </td>
                  <td>
                    <span className="partial">⚠</span> Business Hours
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">Data Migration</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> Free & Assisted
                  </td>
                  <td>
                    <span className="cross">✗</span> Extra Cost
                  </td>
                </tr>
                <tr>
                  <td className="feature-name">Contract Requirements</td>
                  <td className="quotely-col">
                    <span className="check">✓</span> Month-to-Month
                  </td>
                  <td>
                    <span className="cross">✗</span> Annual Lock-in
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="differences-grid">
            <div className="difference-card">
              ...
              <ul className="difference-list">
                <li>
                  See exactly how every quote is calculated with full AI
                  transparency
                </li>
                <li>
                  Generate quotes 60% faster with intelligent data prefill
                </li>
                <li>
                  Pay only for what you use with flexible, transparent pricing
                </li>
            ...
            <div className="difference-card">
              ...
              <ul className="difference-list">
                <li>
                  Black box algorithms with no visibility into calculations
                </li>
        ...
        <div className="container">
          ...
          <div className="pain-points-grid">
            <div className="pain-point-card">
              ...
              <p>
                EZLynx users report spending 12+ seconds per quote, with
                multi-carrier comparisons taking even longer.
              </p>
              <div className="solution">
                <strong>Quotely Solution:</strong> 4.2 second quotes, 8.7 second
                multi-carrier comparisons. Save 3+ hours every day.
              </div>
            </div>
            ...
            <div className="pain-point-card">
              ...
              <p>
                EZLynx's black box approach makes it impossible to explain
                calculations to clients or verify accuracy.
              </p>
              <div className="solution">
                <strong>Quotely Solution:</strong> 100% transparent AI shows you
                exactly how every decision is made.
              </div>
            </div>
            ...
            <div className="pain-point-card">
              ...
              <p>
                What starts at $1,099/month quickly balloons with add-ons, setup
                fees, and surprise charges.
              </p>
              <div className="solution">
                <strong>Quotely Solution:</strong> Transparent pricing starting
                at $679/month. No hidden fees, ever.
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card">
              <p className="testimonial-quote">
                "We cut our quote time by 65% after switching from EZLynx. The
                transparency feature alone has helped us close 30% more deals
                because clients trust us more."
              </p>
            ...
            <div className="testimonial-card">
              <p className="testimonial-quote">
                "EZLynx was costing us $1,400/month with all the add-ons.
                Quotely gives us more features for $929. That's $5,600 saved
                annually."
              </p>
              <div className="testimonial-author">
            ...
            <div className="testimonial-card">
              <p className="testimonial-quote">
                "The migration from EZLynx was painless. Quotely handled
                everything, and we were up and running in 2 days instead of the
                weeks EZLynx took to set up."
              </p>
              <div className="testimonial-author">
      ...
      <section className="migration-section">
        <div className="container">
          <div className="section-header">
            ...
            <p>
              Our white-glove migration service makes the transition seamless
            </p>
          </div>
          ...
          <div className="migration-steps">
            ...
            <div className="step-card">
              ...
              <p>
                We handle all data transfer, including clients, policies, and
                documents
              </p>
            </div>
            ...
            <div className="step-card">
              ...
              <h3>Team Training</h3>
              <p>
                Personalized onboarding for your entire team with ongoing
                support
              </p>
            </div>
            ...
            <div className="step-card">
              ...
              <h3>Go Live</h3>
              <p>Start saving time and money immediately with no downtime</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container">
        <div className="cta-section">
          ...
          <div className="special-offer">
            ...
            <p>
              Get 3 months free when you switch from EZLynx. Plus free data
              migration and dedicated onboarding support.
            </p>
          </div>
