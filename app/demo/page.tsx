...
function DemoPage() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "Thank you! We will contact you within 24 hours to schedule your personalized demo."
    );
    // Reset form
    setFormData({
      name: "",
    ...
    <div>
      ...
      <section className="demo-hero">
        <div className="container">
          ...
          <p>
            See how our AI-powered platform transforms insurance quoting. Book a
            personalized demo or watch our quick overview.
          </p>
      ...
      <section className="demo-content">
        <div className="demo-grid">
          ...
          <div className="demo-form">
            ...
            <p>
              Get a customized walkthrough tailored to your agency's needs and
              current workflow.
            </p>
          ...
          <div className="demo-features">
            ...
            <ul className="feature-list">
              <li>
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Watch us generate a complete auto insurance quote in under 2
                    minutes
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div className="feature-content">
                  ...
                  <p>
                    See how QUAD analyzes risk factors and suggests optimal
                    coverage
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Explore real-time insights into your agency's performance
                    metrics
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Live demonstration of carrier connections and data
                    synchronization
                  </p>
                </div>
              </li>
              ...
              <li>
                ...
                <div className="feature-content">
                  ...
                  <p>
                    See your potential savings and revenue increase with Quotely
                  </p>
                </div>
              </li>
            </ul>
            ...
            >
              ...
              >
                ...
                <strong>No sales pressure</strong> ·{" "}
                <strong>Custom setup for your agency</strong> ·{" "}
                <strong>Q&A with our experts</strong>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="video-container">
            ...
            <p style={{ marginBottom: "2rem", color: "var(--text-secondary)" }}>
              Get a 3-minute overview of Quotely's key features and see why
              1000+ agencies have made the switch.
            </p>

            <div className="video-placeholder">
              <div className="play-button" onClick={handleQuickDemo}>
                ▶
              </div>
              ...
              <div
                style={{
                  ...
                  bottom: "60px",
                  background:
                    "linear-gradient(135deg, #1B2951 0%, #0F1729 100%)",
                  borderRadius: "8px",
                  opacity: 0.4,
                }}
              ></div>
            ...
            >
              🚀 Watch how quotes that take 5+ minutes elsewhere happen in under
              2 minutes with Quotely
            </p>
          </div>
        </div>
      </section>
