        ...
        <div className="dashboard-header">
          <div>
            <h1 className="dashboard-title">
              Insurance Journal Integration Metrics
            </h1>
            <p className="dashboard-subtitle">
              Track performance and impact of syndicated content
            </p>
          </div>
          ...
          <>
            ...
            <div className="charts-section">
              ...
              <div className="chart-card">
                ...
                <div className="chart-placeholder">🎯 Topic Breakdown</div>
              </div>
            </div>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        {article.bridges.map((bridge, i) => (
                          <span key={i} className="bridge-tag">
                            {bridge}
                          </span>
                        ))}
                      </td>
              ...
              <div className="competitor-grid">
                {competitorMentions.map((competitor, index) => (
                  <div key={index} className="competitor-card">
                    ...
                    <span
                      className={`sentiment-badge sentiment-${competitor.sentiment}`}
                    >
