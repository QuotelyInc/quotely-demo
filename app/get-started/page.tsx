...
function GetStartedPage() {
  ...
  const handleSubmit = () => {
    ...
    alert(
      "Welcome to Quotely! Your account is being set up. Check your email for next steps."
    );
  };
              ...
              <>
                  ...
                  <div className="checkbox-group">
                    <div
                      className={`checkbox-item ${
                        formData.painPoints.includes("slow-quotes")
                          ? "selected"
                          : ""
                      }`}
                    ...
                    <div
                      className={`checkbox-item ${
                        formData.painPoints.includes("manual-entry")
                          ? "selected"
                          : ""
                      }`}
                    ...
                    <div
                      className={`checkbox-item ${
                        formData.painPoints.includes("no-transparency")
                          ? "selected"
                          : ""
                      }`}
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={formData.painPoints.includes(
                          "no-transparency"
                        )}
                        onChange={() => {}}
                      />
                    ...
                    <div
                      className={`checkbox-item ${
                        formData.painPoints.includes("expensive")
                          ? "selected"
                          : ""
                      }`}
                    ...
                    <div
                      className={`checkbox-item ${
                        formData.painPoints.includes("poor-support")
                          ? "selected"
                          : ""
                      }`}
                    ...
                    <div
                      className={`checkbox-item ${
                        formData.painPoints.includes("integration")
                          ? "selected"
                          : ""
                      }`}
                ...
                >
                  ...
                  <p style={{ color: "#047857", margin: 0 }}>
                    Click below to create your account and start your 14-day
                    free trial
                  </p>
                </div>
