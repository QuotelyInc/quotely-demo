    ...
    <div>
      ...
      <section className="hero-section">
        <div className="container">
          ...
          <p>
            Expert commentary on insurance technology trends, bridging Insurance
            Journal news with practical AMS solutions
          </p>
        </div>
      </section>
      ...
      <section className="content-section">
        <div className="container">
          ...
          <div className="topic-grid">
            <Link
              href="/industry-insights/ai-technology"
              className="topic-card"
            >
              <div className="topic-icon">🤖</div>
              <h3 className="topic-title">AI & Technology</h3>
              <p className="topic-description">
                How artificial intelligence and emerging tech are reshaping
            ...
            <Link
              href="/industry-insights/customer-experience"
              className="topic-card"
            >
              <div className="topic-icon">💼</div>
              <h3 className="topic-title">Customer Experience</h3>
              <p className="topic-description">
                Modern approaches to client service and satisfaction in
                insurance
              </p>
            ...
            <Link
              href="/industry-insights/ams-technology"
              className="topic-card"
            >
              <div className="topic-icon">⚡</div>
            ...
            <Link
              href="/industry-insights/digital-transformation"
              className="topic-card"
            >
              <div className="topic-icon">🚀</div>
            ...
            <Link
              href="/industry-insights/market-trends"
              className="topic-card"
            >
              <div className="topic-icon">📈</div>
            ...
            <Link
              href="/industry-insights/competitive-analysis"
              className="topic-card"
            >
              <div className="topic-icon">🎯</div>
      ...
      <section className="content-section">
        <div className="container">
          <div className="cta-section">
            ...
            <p>
              See how Quotely's transparent AI platform outperforms traditional
              AMS solutions
            </p>
