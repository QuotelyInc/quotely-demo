...
export default function AutoInsurancePage() {
  ...
  const [animatedMetrics, setAnimatedMetrics] = useState({ speed: 0, faster: 0 })
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <a href="#pricing" className="inline-flex items-center gap-2 bg-white text-purple-700 px-8 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-transform shadow-xl">
                  Start Free Trial
                  <span>→</span>
                </a>
                <a href="#demo" className="inline-flex items-center gap-2 bg-transparent text-white border-2 border-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white/10 transition">
                  Watch Demo
                </a>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-2xl transform hover:scale-105 transition-transform animate-float">
                <div className="bg-gray-50 rounded-xl p-6 mb-4">
                  <div className="flex justify-between mb-3">
                    <span className="font-bold text-gray-900">Quote Progress</span>
                    <span className="text-green-600 font-bold">75%</span>
                  </div>
                  <div className="bg-gray-200 h-2 rounded-full overflow-hidden">
                    <div className="bg-gradient-to-r from-purple-600 to-indigo-600 h-full rounded-full" style={{ width: '75%' }} />
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex items-center gap-4">
              <span className="text-4xl">🚀</span>
              <div>
                <div className="text-3xl font-bold text-green-400">{animatedMetrics.faster}%</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Currently live with Auto Insurance. Additional lines launching Q2/Q3 2025.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow relative border-2 border-green-500">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center gap-2 text-gray-700 font-semibold">
                  <span className="text-green-500">✓</span> Multi-carrier comparison
                </li>
                <li className="flex items-center gap-2 text-gray-700 font-semibold">
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              All plans include the same features. Choose based on your token needs.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:shadow-xl transition-shadow">
              ...
              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-4 rounded-xl mb-6">
                <div className="text-2xl font-bold">{getPricing('QUAD 0.0').tokens} Monthly Tokens</div>
                <div className="text-sm opacity-90">Perfect for small agencies</div>
              </div>

              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> Auto Insurance Quoting (Live)
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> Multi-Carrier Comparison
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> Real-time Rate Engine
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> Instant Bind Capability
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> AI Risk Assessment
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> Mobile Quote Generation
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> Email Support
                </li>
              </ul>
            ...
            <div className="relative bg-white border-2 border-purple-600 rounded-3xl p-8 shadow-xl transform scale-105">
              ...
              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-4 rounded-xl mb-6">
                <div className="text-2xl font-bold">{getPricing('QUAD 3.0').tokens} Monthly Tokens</div>
                <div className="text-sm opacity-90">Ideal for busy agencies</div>
              </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 hover:shadow-xl transition-shadow">
              ...
              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-4 rounded-xl mb-6">
                <div className="text-2xl font-bold">{getPricing('QUAD 7.0').tokens} Monthly Tokens</div>
                <div className="text-sm opacity-90">For high-volume operations</div>
              </div>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-2">
                  <span className="text-green-500 text-xl">✓</span> Dedicated Support
                </li>
              </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition text-center">
              ...
              <p className="text-gray-600">Generate comprehensive quotes in 60 seconds. That's 75% faster than traditional methods.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition text-center">
              ...
              <p className="text-gray-600">Smart automation handles risk assessment, pricing optimization, and carrier matching instantly.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition text-center">
              ...
              <p className="text-gray-600">Quote from anywhere. Our mobile-optimized platform works seamlessly on any device.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition text-center">
              ...
              <p className="text-gray-600">Intuitive interface means your team can start quoting immediately. No lengthy onboarding required.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition text-center">
              ...
              <p className="text-gray-600">Track performance, identify opportunities, and optimize your sales process with live dashboards.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition text-center">
              ...
              <p className="text-gray-600">Bank-level encryption, SOC 2 compliance, and automated backups keep your data safe.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="divide-y">
              <div className="grid grid-cols-4 p-4 items-center hover:bg-gray-50">
                ...
                <div className="text-center text-green-600 font-bold">60 seconds</div>
              ...
              <div className="grid grid-cols-4 p-4 items-center hover:bg-gray-50 bg-gray-50">
                ...
                <div className="text-center text-green-600 font-bold">Full visibility</div>
              ...
              <div className="grid grid-cols-4 p-4 items-center hover:bg-gray-50">
                ...
                <div className="text-center text-green-600 font-bold">Native mobile</div>
                <div className="text-center text-gray-500">Basic responsive</div>
                <div className="text-center text-gray-500">Desktop only</div>
              </div>
              
              <div className="grid grid-cols-4 p-4 items-center hover:bg-gray-50 bg-gray-50">
                <div className="font-semibold">Training Required</div>
                <div className="text-center text-green-600 font-bold">0 hours</div>
              ...
              <div className="grid grid-cols-4 p-4 items-center hover:bg-gray-50">
                ...
                <div className="text-center text-green-600 font-bold">Same day</div>
              ...
              <div className="grid grid-cols-4 p-4 items-center hover:bg-gray-50 bg-gray-50">
                ...
                <div className="text-center text-green-600 font-bold">20+ carriers</div>
