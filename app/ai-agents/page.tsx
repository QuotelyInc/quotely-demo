    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <p className="text-2xl text-gray-300 mb-8 max-w-3xl">
            Autonomous quote generation, intelligent risk assessment, and
            predictive analytics. Our AI agents process 10,000+ decisions per
              ...
              return (
                <div
                  ...
                  className={`bg-gray-800/50 backdrop-blur-lg rounded-xl p-4 border transition-all duration-500 ${
                    activeMetric === i
                      ? "border-blue-500 scale-105 shadow-2xl shadow-blue-500/50"
                      : "border-gray-700"
                  }`}
                >
            ...
            {[
              {
                ...
                description:
                  "Deep learning models analyze 500+ risk factors in milliseconds",
              ...
              },
              {
                ...
                description:
                  "Self-operating AI agents handle routine tasks without human intervention",
              ...
              },
              {
                ...
                description:
                  "Machine learning predicts customer behavior and optimal pricing",
              ...
              },
              {
                ...
                description:
                  "Advanced pattern recognition identifies fraud and evaluates risk profiles",
              ...
              },
              {
                ...
                description:
                  "Understands and processes unstructured documents automatically",
              ...
              },
              {
                ...
                description:
                  "Continuously improves from every interaction and outcome",
              ...
              return (
                <div
                  key={i}
                  className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-6 border border-gray-700 hover:border-blue-500 transition-all hover:scale-105 group"
                >
      ...
      <section className="py-20 px-4 bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-gray-400 text-center mb-12">
            Built on cutting-edge neural architecture and cloud-native
            technology
          </p>
            ...
            <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 border border-gray-700">
              ...
              <div className="space-y-4">
                {[
                  {
                    layer: "Input Layer",
                    desc: "500+ data points ingested",
                    color: "blue",
                  },
                  {
                    layer: "Processing Layer",
                    desc: "TensorFlow & PyTorch models",
                    color: "purple",
                  },
                  {
                    layer: "Decision Layer",
                    desc: "Multi-agent decision trees",
                    color: "pink",
                  },
                  {
                    layer: "Output Layer",
                    desc: "Real-time API responses",
                    color: "green",
                  },
                ].map((item, i) => (
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  {[
                    "Quote generated for Auto Policy",
