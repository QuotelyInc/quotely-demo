        ...
        <div style={styles.additionalResources}>
          ...
          <div style={styles.resourcesGrid}>
            <div style={styles.resourceCard}>
              ...
              <a href="/help" style={styles.resourceLink}>Browse Articles →</a>
            </div>
            ...
            <div style={styles.resourceCard}>
              ...
              <a href="/tutorials" style={styles.resourceLink}>Watch Videos →</a>
            </div>
            ...
            <div style={styles.resourceCard}>
              ...
              <a href="/community" style={styles.resourceLink}>Join Community →</a>
            </div>
            ...
            <div style={styles.resourceCard}>
              ...
              <a href="/training" style={styles.resourceLink}>Register Now →</a>
            </div>
          </div>
        </div>
      </div>
