...
export const AMSContentMap: AMSArticle[] = [
  ...
  },
  {
    ...
    metaDescription: 'Compare leading AMS platforms feature-by-feature. Analyze Quotely vs Applied Epic vs EZLynx vs AMS360 to make informed selection decisions.',
    wordCount: 3000,
    readTime: 12,
    parentId: 'hub',
  ...
  },
  {
    ...
    metaDescription: 'Compare 2025 pricing for Quotely, Applied Epic, EZLynx, AMS360, and more. Get detailed cost breakdowns and value analysis for each platform.',
    wordCount: 1500,
    readTime: 6,
    parentId: 'p3',
